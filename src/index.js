...
const Questions = [
  ...
  },
  {
    ...
    name: 'Navbar',
    description:
      'Display navbar at the top. Different UI for web and mobile platform.',
  },
  {
    num: 3,
    name: 'TwoSum',
    description:
      'Find 2 indices for target sum, by inputting an array of numbers.',
  },
];
      ...
      default:
        return (
          <View style={styles.content}>
            <StyledText type={TextFormat.Header}>Home</StyledText>
            <View style={styles.questionView}>
              <StyledText type={TextFormat.Title}>
                Below are functions available in this app. Please click on any
                to view and test the functionality.
              </StyledText>
